...
<script>
	...
	export default {
		...
		computed: {
			qrData(){
				console.log(_data.data('http_url') + '/#/pages/chat/message/mores?list_id=' + this.list_id + '&inviter_id=' + this.my_data.id)
				return _data.data('http_url') + '/#/pages/chat/message/mores?list_id=' + this.list_id + '&inviter_id=' + this.my_data.id;
			},
		},
		methods: {
			qrR(ref){
